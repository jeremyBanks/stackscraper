...
body = function(manifest) {
  ...
  renderQuestion = function(question, base) {
    ...
    return ("<!doctype html><html>\n<head>\n  <meta charset=\"utf-8\" />\n  <title>\n    " + (encodeHTMLText(question.title)) + "\n  </title>\n  " + (base ? "<base href=\"" + base + "\" />" : '') + "\n  <style>\n    html {\n      background: #D8D8D8;\n    }\n    \n    body {\n      font: 14px sans-serif;\n    }\n      \n    a, a:visited {\n      color: #226;\n    }\n      \n    .wrapper {\n      width: 735px;\n      margin: 1em auto;\n      background: white;\n      padding: 1em;\n    }\n      \n    h1,h2, h3, h4 {\n      padding-bottom: .2em;\n      border-bottom: 1px solid black;\n      margin-top: 0;\n    }\n      \n    h1 {\n      font-size: 1.6em;\n    }\n    h2 {\n      font-size: 1.4em;\n    }\n    h3 {\n      font-size: 1.2em;\n    }\n      \n    h2.answers {\n      border-bottom: 1px solid black;\n    }\n      \n    .implied-by-style {\n      display: none;\n    }\n      \n    .source-header {\n      display: block;\n      background-color: #EEE;\n      padding: 1em 1em;\n      font-size: 1.3em;\n      font-weight: bold;\n      color: black;\n      text-align: left;\n      margin: 0.5em 0;\n      text-align: center;\n    }\n    \n      \n      .source-header a, .source-header a:visited {\n        color: black;\n      }\n      \n    .post .metrics {\n      float: left;\n      text-align: center;\n      width: 58px;\n      margin: 0px 0 0;\n      padding: 5px 0;\n      border-right: 1px solid #DDD;\n    }\n      \n    .post + .post {\n        border-top: 1px solid #888;\n        padding-top: 1em;\n        margin-top: 1em;\n    }\n      \n      .post .metrics .value {\n        display: block;\n        font-weight: bold;\n        font-size: 1.3em;\n        margin: 3px 0 0;\n      }\n        \n      .post .metrics .unit {\n        display: block;\n        opacity: 0.5;\n      }\n        \n      .post .metrics .annotation {\n        display: block;\n        font-weight: bold;\n        font-size: 0.8em;\n        opacity: 0.75;\n        margin: 5px 0 0;\n      }\n      \n    .post .tags {\n      list-style-type: none;\n      padding: 0;\n      line-height: 1.75em;\n    }\n      \n      .post .tags li {\n        display: inline;\n        padding: .3em .5em;\n        margin: .2em;\n        border: 1px solid #888;\n        background: #F8F8F4;\n        font-size: .75em;\n      }\n        .post .tags li a {\n          color: inherit;\n          text-decoration: inherit;\n        }\n        \n      .post .body {\n        line-height: 1.3em;\n      }\n      \n      .post .body p, .post .body pre {\n        margin-top: 0;\n      }\n      \n    .post .attribution {  \n      font-size: 11px;\n      height: 4em;\n      float: right;\n      width: 160px;\n      border: 1px solid #E8E8E4;\n      margin-left: 1em;\n      padding: 4px;\n      padding-bottom: 8px;\n      background: #F8F8F4;\n      position: relative;\n      line-height: 1.6em;\n      margin-bottom: 8px;\n    }\n      \n      .post .attribution img {\n        border: 1px solid #E8E8E4;\n        border-right: 0;\n        border-bottom: 0;\n        float: right;\n        position: absolute;\n        bottom: 0px;\n        right: 0px;\n      }\n      \n    .post .col {\n      float: right;\n      width: 665px;\n    }\n\n    .post .col img {\n      max-width: 665px;\n    }\n    \n    blockquote {\n      margin: .5em .25em;\n      margin-bottom: .75em;\n      padding: 1em;\n      padding-bottom: 0.5em;\n      background: #EEE;\n    }\n      \n    pre {\n      background: #EEE;\n      padding: 8px 8px;\n      margin-bottom; 10px;\n      font: 100% Menlo, Monaco, Consolas, \"Lucida Console\", monospace;\n      line-height: 1.3em;\n      overflow-x: scroll;\n    }\n      \n    .footer {\n      font-size: 0.8em;\n      text-align: center;\n    }\n      \n    .footer a {\n      text-decoration: none;\n      color: #222;\n    }\n      \n    .footer a:hover {\n      text-decoration: underline;\n    }\n    \n    .comments {\n      display: none;\n    }\n    \n    .comments:target {\n      display: block;\n    }\n    \n    \n    .comments .comment {\n      padding: .125em;\n      border: .125em solid #EEE;\n      background: #F8F8F8;\n    }\n    \n    .comments .comment .score, .comments .comment .author {\n      font-weight: bold;\n    }\n  </style>\n</head>\n<body>\n  <div class=\"wrapper\">\n    <div class=\"question post\" id=\"" + (encodeHTMLText(question.post_id)) + "\">\n      <h1>" + (encodeHTMLText(question.title)) + "</h1>\n      \n      <div class=\"metrics\">\n        <span class=\"value\">" + question.score + "</span>\n        <span class=\"unit\">votes</span>\n        <br>\n        <span class=\"value\">" + question.view_count + "</span>\n        <span class=\"unit\">views</span>\n          " + (question.comments.length ? "<br><a href=\"javascript:void(location.hash = '" + question.post_id + "-comments')\" style=\"text-decoration: none;\"><span class=\"value\">" + question.comments.length + "</span><span class=\"unit\" style=\"font-size: 75%;\">comments</span></a>" : '') + "\n      </div>\n      <div class=\"col\">\n        <div class=\"body\">\n          " + question.body + "\n        </div>") + (question.owner || question.creation_date_s ? "  <div class=\"attribution\">\n    asked " + (question.owner ? "by <a href=\"/u/" + (encodeHTMLText(question.owner.user_id)) + "\">" + (encodeHTMLText(question.owner.display_name)) + "<img src=\"" + (encodeHTMLText(question.owner.profile_image)) + "\" alt=\"\" /></a><br>" : '<br>') + "\n    " + question.creation_date_s + "\n</div>" : '') + (question.last_edit_date_s || question.last_editor ? "  <div class=\"attribution\">\n    edited " + (question.last_editor ? "by <a href=\"/u/" + (encodeHTMLText(question.last_editor.user_id)) + "\">" + (encodeHTMLText(question.last_editor.display_name)) + "<img src=\"" + (encodeHTMLText(question.last_editor.profile_image)) + "\" alt=\"\" /></a><br>" : '<br>') + "\n    " + (encodeHTMLText(question.last_edit_date_s)) + "\n</div>" : '') + ("  <ul class=\"tags\">\n    " + (((function() {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        comment = _ref2[_i];
        _results.push("<div class=\"comment\">" + ("<span class=\"score\">[" + comment.score + "]</span> ") + ("<span class=\"author\"><a href=\"/u/" + comment.user_id + "\">" + (encodeHTMLText(comment.display_name)) + "</a>:</span> ") + ("<span class=\"body\">" + comment.body + "</span>") + "</div>");
      }
      return _results;
